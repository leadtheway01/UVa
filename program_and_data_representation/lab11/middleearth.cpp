/*! \mainpage CS2150 lab 11 Wright Kim (wdk7bj)
 */

 /** \file middleearth.cpp
 * \details Implementation of middleearth.h
 * \author Arron Bloomfield
 * \author commented by Wright Kim (wdk7bj)
 * \date 11/30/2015
 */
...
/**@brief List of all possible cities that can be generated
*/
...
/**@brief Creates 2D map with randomly generated cities.
 *
 * \details If user defined number of cities, num_cities is less than randomly generated num_city_names, program exits
 * \details If num_cities is less than 5, the num_cities is 5
 * \details Randomly generate city names from all_city_names array
 * \details Randomly generate the locate of all of the cities generated
 * \details Calculates the distance between cities
 *
 *@param xsize x coordinate of 2D map
 *@param ysize y coordinate of 2D map
 *@param num_cities user defined number of cities in the middle earth
 *@param seed different seed value will enable to generate real random numbers
 */
...
/*! \relates MiddleEarth
 *@brief Destructor
 * \details remove the connections between the cities, hence detroys the middle earth map
 * \details No parameter needed
 */
...
/** @brief prints out all of the cities on the map with it's position
 * \details No parameter needed
 */
...
/*! \relates MiddleEarth
 *@brief prints all cities and it's location in table
 * \details No parameter needed 
 */
...
/*! \relates MiddleEarth
 *@brief get distance of two cities
 *
 *@return Returns distance between two cities in float type
 *@param city1 First city to get distance between two cities
 *@param city2 Second city to get distance between two cities
 */
...
/*! \relates MiddleEarth
 *@brief Returns the list of cities to travel
 * \details The route to travel the list of cities are generated randomly
 *@return vector<string> itinerary
 *@param length To account for the start point
 */
